...
using ENB.Restaurant.Event.Bookings.EF.ConfigurationEntity;
...
namespace ENB.Restaurant.Event.Bookings.EF
{
    ...
    /// </summary>
    public class RestaurantEventBookingContext : IdentityDbContext<ApplicationUser>
    {
       

        public RestaurantEventBookingContext(DbContextOptions<RestaurantEventBookingContext>  options)
               :base(options)
        {
